...
# "AirPassengers" содержащий информацию о ежемесячном количестве пассажиров, перевезённых международными авиалиниями из 1949 по 1960 год
data_loader = sm.datasets.get_rdataset("AirPassengers")
data = data_loader.data

# Числовой индекс данных заменяется соответствующими датами
